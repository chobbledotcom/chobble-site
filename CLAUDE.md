...
- **Setting up strawmen to knock them down** — "Most restaurant websites bury the menu in a PDF", "Most developers overcharge", "Most agencies don't care about your business". This is a classic sales page structure: paint everyone else as incompetent so you look good by comparison. Stef doesn't do this. He explains what he builds and why it works, and lets the reader draw their own conclusions. If you find yourself writing a paragraph about what "most" other people do badly, delete it and write about what you do instead.
...
- **Being sassy or self-congratulatory** — "That is not shabby", "which was kind of the point of the exercise", "no remembering to hit a button or waiting for a cron job". The voice is confident but never pleased with itself. Let the facts do the work. If a line reads like a knowing wink or a pat on your own back, cut it. This also covers overselling modifiers ("practically psychic", "blazing fast") and casual dismissiveness of other people's tools or workflows — there's no need to score points off WordPress or cron jobs to make the case for static sites. This is not the same as nerd enthusiasm ("nerdy stuff", "techie speccies", "whizz-bangery") — those are personality, not puffery. Don't sand off the genuine interest in the name of avoiding overselling.
